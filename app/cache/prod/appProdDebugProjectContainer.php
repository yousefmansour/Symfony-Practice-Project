...
class appProdDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'app.event' => 'getApp_EventService',
            'app.player' => 'getApp_PlayerService',
            'app.sport' => 'getApp_SportService',
            'app.team' => 'getApp_TeamService',
    ...
    /**
     * Gets the 'app.event' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Service\EventService A AppBundle\Service\EventService instance.
     */
    protected function getApp_EventService()
    {
        return $this->services['app.event'] = new \AppBundle\Service\EventService($this->get('doctrine.orm.default_entity_manager'), $this->get('session'));
    }

    /**
     * Gets the 'app.player' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Service\PlayerService A AppBundle\Service\PlayerService instance.
     */
    protected function getApp_PlayerService()
    {
        return $this->services['app.player'] = new \AppBundle\Service\PlayerService($this->get('doctrine.orm.default_entity_manager'));
    }

    /**
     * Gets the 'app.sport' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Service\SportService A AppBundle\Service\SportService instance.
     */
    protected function getApp_SportService()
    {
        return $this->services['app.sport'] = new \AppBundle\Service\SportService($this->get('doctrine.orm.default_entity_manager'));
    }

    /**
     * Gets the 'app.team' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Service\TeamService A AppBundle\Service\TeamService instance.
     */
    protected function getApp_TeamService()
    {
        return $this->services['app.team'] = new \AppBundle\Service\TeamService($this->get('doctrine.orm.default_entity_manager'));
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'uni_project', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_2d3518950209e42ffc430b9f9890865cc4b1331455080c4c66fb3cdcde81f522');
    ...
    {
        return $this->services['security.encoder_factory'] = new \Symfony\Component\Security\Core\Encoder\EncoderFactory(array('AppBundle\\Entity\\Player' => array('class' => 'Symfony\\Component\\Security\\Core\\Encoder\\BCryptPasswordEncoder', 'arguments' => array(0 => 12)), 'Symfony\\Component\\Security\\Core\\User\\User' => array('class' => 'Symfony\\Component\\Security\\Core\\Encoder\\BCryptPasswordEncoder', 'arguments' => array(0 => 12))));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $g = new \Symfony\Component\HttpFoundation\RequestMatcher('/events');

        $h = new \Symfony\Component\HttpFoundation\RequestMatcher('/teams');

        $i = new \Symfony\Component\HttpFoundation\RequestMatcher('/sports');

        $j = new \Symfony\Component\HttpFoundation\RequestMatcher('/events/delete');

        $k = new \Symfony\Component\HttpFoundation\RequestMatcher('/teams/delete');

        $l = new \Symfony\Component\HttpFoundation\RequestMatcher('/events/create');
        ...
        $p->setOptions(array('login_path' => 'login', 'default_target_path' => 'event_list', 'always_use_default_target_path' => false, 'target_path_parameter' => '_target_path', 'use_referer' => false));
        ...
        return $this->services['security.firewall.map.context.main'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => new \Symfony\Component\Security\Http\Firewall\ChannelListener($m, new \Symfony\Component\Security\Http\EntryPoint\RetryAuthenticationEntryPoint(80, 443), $a), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($b, array(0 => $this->get('security.user.provider.concrete.chain_provider'), 1 => $this->get('security.user.provider.concrete.in_memory'), 2 => $this->get('security.user.provider.concrete.db_provider')), 'main', $a, $c), 2 => $o, 3 => new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($b, $f, new \Symfony\Component\Security\Http\Session\SessionAuthenticationStrategy('migrate'), $n, 'main', $p, $q, array('check_path' => 'login', 'use_forward' => false, 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'authenticate', 'post_only' => true), $a, $c, NULL), 4 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($b, '58751b9dd6adb1.88529853', $a, $f), 5 => new \Symfony\Component\Security\Http\Firewall\AccessListener($b, $this->get('security.access.decision_manager'), $m, $f)), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($b, $this->get('security.authentication.trust_resolver'), $n, 'main', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($e, $n, 'login', false), NULL, NULL, $a, false));
    }
    ...
    {
        return $this->services['security.user.provider.concrete.chain_provider'] = new \Symfony\Component\Security\Core\User\ChainUserProvider(array(0 => $this->get('security.user.provider.concrete.db_provider'), 1 => $this->get('security.user.provider.concrete.in_memory')));
    }
    ...
    {
        return $this->services['security.user.provider.concrete.db_provider'] = new \Symfony\Bridge\Doctrine\Security\User\EntityUserProvider($this->get('doctrine'), 'AppBundle:Player', 'username', NULL);
    }
    ...
    protected function getSecurity_User_Provider_Concrete_InMemoryService()
    {
        ...
        $instance->createUser(new \Symfony\Component\Security\Core\User\User('admin', '$2y$12$boqY0eVVF5t2gCtp3tZ.S.uvtveqedHmx3KO9uYgWanZPhBEbgHtS', array(0 => 'ROLE_ADMIN')));
